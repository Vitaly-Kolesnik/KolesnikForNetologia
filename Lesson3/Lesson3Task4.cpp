...
int main() {
    ...
    case 1:
        switch (ones) {
        case 0: std::cout << "десять"; return 0;
        case 1: std::cout << "одиннадцать"; return 0;
        case 2: std::cout << "двенадцать"; return 0;
        case 3: std::cout << "тринадцать"; return 0;
        case 4: std::cout << "четырнадцать"; return 0;
        case 5: std::cout << "пятнадцать"; return 0;
        case 6: std::cout << "шестнадцать"; return 0;
        case 7: std::cout << "семнадцать"; return 0;
        case 8: std::cout << "восемнадцать"; return 0;
        case 9: std::cout << "девятнадцать"; return 0;
        }
    case 0: break;
    }
